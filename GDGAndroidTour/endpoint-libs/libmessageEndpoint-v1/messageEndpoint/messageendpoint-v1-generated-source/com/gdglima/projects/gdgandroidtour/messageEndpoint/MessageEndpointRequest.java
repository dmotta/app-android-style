 ...
 *  on 2013-03-08 at 23:44:07 UTC 
 */

package com.gdglima.projects.gdgandroidtour.messageEndpoint;
...
public abstract class MessageEndpointRequest<T> extends AbstractGoogleJsonClientRequest<T> {
  ...
  /** Data format for the response. */
  public MessageEndpointRequest<T> setAlt(String alt) {
    this.alt = alt;
    return this;
  }
  ...
  /** Selector specifying which fields to include in a partial response. */
  public MessageEndpointRequest<T> setFields(String fields) {
    this.fields = fields;
    return this;
  }
 ...
 * reports. Required unless you provide an OAuth 2.0 token.
 */
  public MessageEndpointRequest<T> setKey(String key) {
    this.key = key;
    return this;
  }
  ...
  /** OAuth 2.0 token for the current user. */
  public MessageEndpointRequest<T> setOauthToken(String oauthToken) {
  ...
  /** Returns response with indentations and line breaks. */
  public MessageEndpointRequest<T> setPrettyPrint(Boolean prettyPrint) {
 ...
 * assigned to a user, but should not exceed 40 characters. Overrides userIp if both are provided.
 */
  public MessageEndpointRequest<T> setQuotaUser(String quotaUser) {
 ...
 * limits.
 */
  public MessageEndpointRequest<T> setUserIp(String userIp) {
    this.userIp = userIp;
    return this;
  }
  ...
  @Override
  public MessageEndpointRequest<T> setRequestHeaders(HttpHeaders headers) {
