 ...
 *  on 2013-03-08 at 23:44:33 UTC 
 */

package com.gdglima.projects.gdgandroidtour.deviceinfoendpoint;
...
public class Deviceinfoendpoint extends AbstractGoogleJsonClient {
  ...
  public class GetDeviceInfo extends DeviceinfoendpointRequest<com.gdglima.projects.gdgandroidtour.deviceinfoendpoint.model.DeviceInfo> {
    ...
    protected GetDeviceInfo(String id) {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, com.gdglima.projects.gdgandroidtour.deviceinfoendpoint.model.DeviceInfo.class);
   ...
   * operation.
   *
   * @param content the {@link com.gdglima.projects.gdgandroidtour.deviceinfoendpoint.model.DeviceInfo}
   * @return the request
   */
  public InsertDeviceInfo insertDeviceInfo(com.gdglima.projects.gdgandroidtour.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    InsertDeviceInfo result = new InsertDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class InsertDeviceInfo extends DeviceinfoendpointRequest<com.gdglima.projects.gdgandroidtour.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected InsertDeviceInfo(com.gdglima.projects.gdgandroidtour.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "POST", REST_PATH, content, com.gdglima.projects.gdgandroidtour.deviceinfoendpoint.model.DeviceInfo.class);
    }
  ...
  public class ListDeviceInfo extends DeviceinfoendpointRequest<com.gdglima.projects.gdgandroidtour.deviceinfoendpoint.model.CollectionResponseDeviceInfo> {
    ...
    protected ListDeviceInfo() {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, com.gdglima.projects.gdgandroidtour.deviceinfoendpoint.model.CollectionResponseDeviceInfo.class);
    }
  ...
  public class RemoveDeviceInfo extends DeviceinfoendpointRequest<com.gdglima.projects.gdgandroidtour.deviceinfoendpoint.model.DeviceInfo> {
    ...
    protected RemoveDeviceInfo(String id) {
      super(Deviceinfoendpoint.this, "DELETE", REST_PATH, null, com.gdglima.projects.gdgandroidtour.deviceinfoendpoint.model.DeviceInfo.class);
      this.id = Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public UpdateDeviceInfo updateDeviceInfo(com.gdglima.projects.gdgandroidtour.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    UpdateDeviceInfo result = new UpdateDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class UpdateDeviceInfo extends DeviceinfoendpointRequest<com.gdglima.projects.gdgandroidtour.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected UpdateDeviceInfo(com.gdglima.projects.gdgandroidtour.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "PUT", REST_PATH, content, com.gdglima.projects.gdgandroidtour.deviceinfoendpoint.model.DeviceInfo.class);
    }
